...
Download the Tagxi app Today</strong></h2>',
...
<h2><strong>Carolina</strong></h2>',
                'footertextsub' => '<p>Tagxi is a rideshare platform facilitating peer to peer ridesharing by means of connecting passengers who are in need of rides from drivers with available cars to get from point A to point B with the press of a button.</p>',
                'footercopytextsub' => '<p>&copy; 2021 Tagxi, LLC All rights reserved. <a href="http://localhost/taxiwebnew/index.php#" target="blank"> Powered By Tagxi </a></p>',
                'footerlogo'=>'logo.png',
...
<br />
<strong>SOS Contact Information</strong> Our application requires access to your contact list to enable the SOS feature, which is designed to enhance user and driver safety. When you choose to add SOS contacts, the app will request permission to access your device contact list. This access allows you to easily select trusted contacts to be notified in case of an emergency.<br />
We ensure that:<br />

Contact data is not uploaded to our servers or shared with third parties.<br />

Contact access is used only locally on your device for the sole purpose of enabling SOS functionality.<br />

No messages or calls are made without your explicit action or consent.<br />

The contact list access is optional, and you can choose whether or not to grant this permission. The SOS feature will function only if permission is granted.<br />

Your privacy and data security are important to us. We do not collect, store, or transmit any contact data beyond what is necessary for enabling this safety feature.<br />
<br />
...
<li>North Carolina vehicle inspection</li>
                    ...
                    'afrhtext' => '<h1><strong>Download the Driver Tagxi app Today</strong></h1>',
...
<h3>Hours are completely flexible. Drive mornings, evenings, weekdays, or weekends.</h3>',
                    ...
                    'asrstext1' => '<p>Download the Tagxi Driver App from the Google Play or App Store on your smartphone.</p>',
