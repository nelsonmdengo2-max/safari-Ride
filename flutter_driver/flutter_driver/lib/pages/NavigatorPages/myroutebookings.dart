                                                    ...
                                                    ? Material(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            ...
                                                            var val;
                                                                  if (addAutoFill[i]['lat'] == '' || addAutoFill[i]['lat'] == null){
                                                                    if (mapType == 'google') {
                                                                        ...
                                                                        val = await geoCodingForLatLngOSM(addAutoFill[i]['place']);
                                                                      }
                                                                      _sessionToken = null;
                                                                  }
                                                                  setState(() {
                                                                      _centerLocation = (addAutoFill[i]['lat'] == '' || addAutoFill[i]['lat'] == null)
                                                                          ? LatLng(double.parse(val['latitude'].toString()), double.parse(val['longitude'].toString()))
                                                                          : LatLng(double.parse(addAutoFill[i]['lat'].toString()), double.parse(addAutoFill[i]['lon'].toString()));
                                                                      homeAddressConfirmation =
                                                                          addAutoFill[i]
                                                                              [
                                                                              'description'];
                                                            ...
                                                            // // }
                                                            // setState(() {
                                                            //   _centerLocation = (addAutoFill[i]['lat'] ==
                                                            //               '' ||
                                                            //           addAutoFill[i]
                                                            //                   [
                                                            //                   'latitude'] ==
                                                            ...
                                                            //                   .toString()),
                                                            //           double.parse(
                                                            //               addAutoFill[i]['longitude'].toString()));
                                                            //   homeAddressConfirmation =
                                                            //       addAutoFill[i]
                                                            //           [
                                                            //           'description'];
