                                  ...
                                  : fm.FlutterMap(
                                      ...
                                      children: [
                                        fm.TileLayer(
                                          ...
                                          userAgentPackageName: 'package name'
                                          // 'com.example.app',
                                        ),
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                    ...
                                                                    setState(() {
                                                                      useMyAddress =
                                                                          true;
                                                                      _center = (addAutoFill[i]['lat'] == '' || addAutoFill[i]['latitude'] == null)
                                                                          ? LatLng(double.parse(val['latitude'].toString()), double.parse(val['longitude'].toString()))
                                                                          : LatLng(double.parse(addAutoFill[i]['latitude'].toString()), double.parse(addAutoFill[i]['longitude'].toString()));
                                                                      pickupAddressConfirmation =
                                                                          addAutoFill[i]
                                                                              [
                                                                              'description'];
