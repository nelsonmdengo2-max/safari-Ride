    ...
    <div class="wrapper skin-blue-light">
        ...
        <div class="content-wrapper">
            ...
            <audio id="sosplayer">
                ...
                @if ($app_for === 'demo')
                    <a href="https://codecanyon.net/item/tagxi-flutter-complete-taxi-booking-solution/37567287?s_rank=6" target="_blank" class="sticky-demo-btn"><i class="fa fa-cart-plus"></i> Buy On Envato</a>
                @endif
            <!-- Main view  -->
            @yield('content')
